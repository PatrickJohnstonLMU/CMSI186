...
public class BrobIntTester {
   ...
   //large numnber est strings
   private static String g21String = "144127909719710664015092431502440849849506284148982076191826176553";
   //large number with addition in front
   private static String g22String = "+144127909719710664015092431502440849849506284148982076191826176553";
   //large number with minus in front
   private static String g23String = "-144127909719710664015092431502440849849506284148982076191826176553";
   //large number with addition in middle
   private static String g24String = "1441279097197106640150924315024408+49849506284148982076191826176553";    
   //large number with negative in middle
   private static String g25String = "14412790971971066401509243150244084-9849506284148982076191826176553"; 
   //large number with 2 symbols in front
   private static String g26String = "-+144127909719710664015092431502440849849506284148982076191826176553"; 
   //large number with zeroes in front
   private static String g27String = "0000144127909719710664015092431502440849849506284148982076191826176553"; 
   //large number with random character C in middle
   private static String g28String = "1441279097197106640150924315024408C49849506284148982076191826176553"; 

   //Testing character string
   private static String g29String = "c"; 
   //character string with symbol in front
   private static String g30String = "-c"; 
   ...
   public static void main( String[] args ) {
      ...
      System.out.println( "   1.0 TESTING CONSTRUCTOR AND CONSTANTS:\n" +
                          "    ==================================" );
      try {
         System.out.println( "    Test : Making a new BrobInt: " );
      ...
      System.out.println( "\n    Test : Making a second new BrobInt [same as first]: " );
      try {
      ...
      try {
         System.out.println( "    Test : Comparing equality of g1 and g2 with 'equals()': " );
         System.out.println( "      expecting: true\n" + "        and got: " + g1.equals( g2 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "\n    Test : Making a third new BrobInt [differs at position 47    |]: " +
      ...
      try {
         System.out.println( "    Test : Comparing equality of g1 and g3 [detect different digit]: " );
         System.out.println( "      expecting: false\n" + "        and got: " + g1.equals( g3 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "\n    Test : Making a fourth new BrobInt [same as g3 but truncated]: "  );
      ...
      try {
         System.out.println( "    Test : Comparing equality of g3 and g4 [detect different length prior to detecting different digit]: " );
         System.out.println( "      expecting: false\n" + "        and got: " + g3.equals( g4 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "\n    Test : Making a fifth new BrobInt, checking BrobInt.ZERO: "  );
         g5 = new BrobInt( "0" );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      ...
      try {
         System.out.println( "\n    Test : Making a sixth new BrobInt, checking BrobInt.ONE: "  );
         g6 = new BrobInt( "1" );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      ...
      try {
         System.out.println( "\n    Test : Making a seventh new BrobInt, checking BrobInt.TEN: "  );
